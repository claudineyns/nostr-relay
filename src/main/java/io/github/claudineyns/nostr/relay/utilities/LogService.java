...
public final class LogService {
	...
	public byte info(final String template, final Object... args) {
		return logv(template, LogLevel.INFO, args);
	}
	
	public byte debug(final String template, final Object... args) {
		return logv(template, LogLevel.DEBUG, args);
	}
	
	public byte error(final String template, final Object... args) {
		return logv(template, LogLevel.ERROR, args);
	}
	
	public byte error(final String message, final Throwable throwable) {
	...
	public byte warning(final String template, final Object... args) {
		return logv(template, LogLevel.WARN, args);
	}
	
	private byte logv(final String template, final LogLevel level, final Object... args) {
